...
public class AdventOfCode12_1 {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        Grid firstGrid = new Grid(heights,visited,start_row,start_col, start_row, start_col, dest_row, dest_col, 0);
        q.add(firstGrid);
        boolean[][] best_visited = new boolean[max_row+1][max_col+1];
        while( q.size() > 0 )
            {
            Grid grid = q.remove();
